...
fn main() {
    ...
    let crypter : [u8;128] = encryptX8(&inputX8, &key);
    let decrypter : [u8;128] = decrypytX8(&crypter, &key);
...
return the encrypted array as an array of unsigned int
*/
fn encryptX8(input : &[u8], key : &[u8]) -> [u8;128] {
...
return the decrypted array as an array of unsigned int
*/
fn decrypytX8(input : &[u8], key : &[u8]) -> [u8;128] {
    let mut output =  [1u8;128];
    //initialize the Decryptor
